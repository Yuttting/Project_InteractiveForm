...
<body>
    ...
    <form action="index.html" method="post" novalidate>
      ...
      <fieldset>         
        ...
        <span>Name field can't be blank.</span>
        
        <label for="mail">*Email:</label>
        <input type="email" id="mail" name="user-email">
        <span>Must be a validly formatted e-mail address</span>
      ...
      <fieldset class="activities">
        <legend>*Register for Activities</legend>
          <span>User must select at least one checkbox under the "Register for Activities" section of the form.</span>
          <label>
      ...
      <fieldset>
        ...
        <div id="credit-card" class="credit-card">
          ...
          <div class="col-6 col">
            ...
            <span>Credit Card field only accepts a number between 13 and 16 digits.</span>
          </div>

          <div class="col-3 col">
            <label for="zip">*Zip Code:</label>
            <input id="zip" name="user-zip" type="text"> 
            <span>The Zip Code field accepts a 5-digit number.</span>
          </div>

          <div class="col-3 col">
            <label for="cvv">*CVV:</label>
            <input id="cvv" name="user-cvv" type="text"> 
            <span>The CVV should only accepts a number that is exactly 3 digits long.</span>
          </div>
